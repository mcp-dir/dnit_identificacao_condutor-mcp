...
DNIT: Identificação de Condutor Infrator segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [dnit_identificacao_condutor@mcp.ai](mailto:dnit_identificacao_condutor@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
